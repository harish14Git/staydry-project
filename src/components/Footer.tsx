    ...
    <footer className={styles.footer}>
          ...
          {/* LEFT COLUMN */}
            ...
            <div className={styles.contactBlock}>
              <div className={styles.contactRow}>
                <Image src={phone} alt="Call" width={18} height={18} />
                <span>Call Us</span>
              </div>
              <div className={styles.contactRow}>
        ...
        {/* BOTTOM BAR */}
          ...
          <div className={styles.botline}>
            <span>&copy; Copyright 2025 Staydry ABN 67167519039</span>
            </div>
          <div className={styles.socialRight}>
            <Image src={facebook} alt="fb" width={22} height={22} />
            <Image src={linkedin} alt="in" width={22} height={22} />
            <Image src={instagram} alt="ig" width={22} height={22} />
